...
public abstract class Complex {
    ...
    public abstract void multiplyInPlace(Complex other);
    ...
    public abstract Complex divide(Complex other);
    ...
    public abstract Complex getConjugate(Complex number);
    ...
    public static Complex[] flatten(Complex[][] original)
    {
        ...
        for (int i=0; i<numRows; i++)
        {
            System.arraycopy(original[i], 0, flattened, i*numColumns, numColumns);
        }
        return flattened;
    }
